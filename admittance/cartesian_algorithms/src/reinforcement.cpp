...
{   
    ...
    {   
        ...
        case 1:
            {delta_x = 0.00; delta_y = -0.0066;}break;
        case 2:
            {delta_x = 0.000; delta_y = -0.01;}break;
        case 3:
            {delta_x = 0.00; delta_y = -0.006;}break;
        default:
            break;
        }
        // 节点抓放
